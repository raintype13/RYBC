        ...
        >
          ...
          <SwiperSlide className="flex flex-col items-center justify-center p-8 text-center relative">
            ...
            <div className="flex items-center justify-center w-full mb-4 scale-110"> 
              {/* scale-110 аккуратно увеличивает весь таймер целиком */}
              <Countdown />
            </div>

            {/* Подписи стали крупнее и чуть заметнее */}
          ...
          {/* Второй слайд: Улучшенная дата выхода */}
            ...
            <div className="relative w-full py-6 px-4 rounded-3xl bg-[#151515]/50 border border-white/5 shadow-2xl overflow-hidden">
              ...
              <div className="flex justify-between items-center w-full px-2 mt-4">
                <div className="flex flex-col items-start">
                  <span className="text-[8px] text-gray-600 uppercase tracking-widest mb-0.5">Platform</span>
                  <span className="text-[10px] font-bold text-gray-300">pump.fun</span>
                </div>
                <div className="h-6 w-px bg-white/5" />
                <div className="flex flex-col items-end">
                  <span className="text-[8px] text-gray-600 uppercase tracking-widest mb-0.5">Status</span>
                  <span className="text-[10px] font-bold text-[#00ff88]">CONFIRMED</span>
                </div>
              </div>
  ...
  <div className="flex flex-col items-center gap-2">
    ...
    <div className="flex items-center gap-4 mb-2">
      ...
      <div className="flex flex-col items-start text-left">
        ...
        <span className="text-[11px] text-gray-500 uppercase tracking-widest font-bold mt-1">
          RYB Coin
        </span>
      </div>
    </div>
              ...
              <div className="flex flex-col items-center">
                <div className="flex items-baseline gap-2">
                  <span className="text-4xl font-black tracking-tighter text-[#00ff88]">
                    $0.00426
                  </span>
                  <span className="text-[10px] font-bold text-[#00ff88] bg-[#00ff88]/10 px-2 py-0.5 rounded-md">
                    +12.4%
                  </span>
                </div>
      ...
      <div className="bg-[#101010] rounded-4xl p-6 flex flex-col gap-6">
        ...
        <div className="flex flex-col">
          {socials.map((social) => (
            <div key={social.name} className="flex flex-col">
              <div className="flex justify-between items-center py-4 px-1">
                ...
                <button className="bg-white text-black px-6 py-1.5 rounded-full font-bold text-sm active:scale-95 transition-transform">
                  GO
                </button>
              </div>
          ...
          <div className="flex justify-between items-center py-5 px-1">
            <div className="flex flex-col">
              <span className="text-gray-200 font-semibold text-lg">Referrals</span>
              <span className="text-[11px] text-gray-500 uppercase tracking-widest mt-0.5 font-medium">Invite 3 friends</span>
            </div>
            <span className="text-white font-bold bg-[#1a1a1a] px-4 py-1.5 rounded-xl text-lg">
              0 / 3
            </span>
          </div>
        </div>
